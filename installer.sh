...
#configuration
###########################################
plugin=ServerEagleSat-main
url=https://github.com/eliesat/ServerEagleSat/archive/main.tar.gz
...
if [ $extract -eq 0 ]; then
    rm -rf /usr/lib/enigma2/python/Plugins/Extensions/ServerEagleSat >/dev/null 2>&1
